...
description: "How MiniBrief handles your data. Your email is processed in your browser and never stored on our servers; the waitlist collects only the email you submit."
...
For Outlook we use the equivalent Microsoft Graph permissions. You can review and revoke this access at any time — for Google at [myaccount.google.com/permissions](https://myaccount.google.com/permissions), and for Microsoft in your account settings.
...
MiniBrief's use of information received from Google APIs adheres to the [Google API Services User Data Policy](https://developers.google.com/terms/api-services-user-data-policy), including the Limited Use requirements. In particular, MiniBrief:
